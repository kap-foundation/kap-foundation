 ...
 * @notice Used by Kapital DAO team members and private investors as a method
 * of locking and linearly vesting KAP
 */
contract Vesting is AccessControlEnumerable, IVotingWeightSource {
    ...
    constructor(
        ...
        address _futureInvestors,
        address _kapToken,
        address _governanceRegistry
    ) {
        require(_teamMultisig != address(0), "Vesting: Zero address");
        require(_futureInvestors != address(0), "Vesting: Zero address");
        ...
        _grantRole(VESTING_CREATOR, _futureInvestors);
        _grantRole(VESTING_CREATOR, msg.sender); // renounced after initial vesting agreement creation
    }
